...
import { FileText, FileImage, FileSpreadsheet, Download, Search, FolderOpen, Ship, Box, Trash2, Edit2 } from 'lucide-react';
...
export const GlobalCloudManager: React.FC<GlobalCloudManagerProps> = ({
    isOpen, isMinimized, onClose, onMinimize, jobs, bls, onUpdateBL, zIndex, onFocus, triggerRect, id
}) => {
