...
interface ShipmentDetailProps {
    ...
    onOpenCloudManager: (rect?: { x: number, y: number, width: number, height: number }) => void;
                    ...
                    <div className="col-span-12 lg:col-span-3 flex flex-col gap-6">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 p-5">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <button onClick={(e) => { const rect = e.currentTarget.getBoundingClientRect(); onOpenCloudManager({ x: rect.left, y: rect.top, width: rect.width, height: rect.height }); }} className="p-1.5 hover:bg-blue-100 dark:hover:bg-slate-600 text-blue-600 dark:text-blue-400 rounded-lg transition-colors relative group" title="Cloud File Manager">
                                    <FolderPlus size={18} />
